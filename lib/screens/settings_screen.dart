      ...
      body: ListView(
        children: [
          ...
          _SettingsTile(
            ...
            subtitle:
                'Activity, privacy, interactions, sounds, language & data',
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const KrevzyPreferencesScreen(),
                ),
              );
            },
          ),
          ...
          _sectionTitle('Payments & Wallet'),

          _SettingsTile(
            icon: Icons.account_balance_wallet_outlined,
            title: 'Wallet & Payments',
            subtitle: 'Manage bank account, UPI verification and payments',
            onTap: () {
              Navigator.push(
                context,
          ...
          _SettingsTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const DataMediaQualityScreen(),
                ),
              );
            },
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SwitchListTile(
                        ...
                        value: showOnline,
                        onChanged: (value) {
                          setSheetState(() => showOnline = value);
                        },
                      ),
                      SwitchListTile(
                        ...
                        value: showLastSeen,
                        onChanged: (value) {
                          setSheetState(() => showLastSeen = value);
                        },
                      ),
                      SwitchListTile(
                        ...
                        value: readReceipts,
                        onChanged: (value) {
                          setSheetState(() => readReceipts = value);
                        },
                      ),
