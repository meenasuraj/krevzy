              ...
              TextButton.icon(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Story published successfully for 24 hours! 📸',
                      ),
                    ),
                  );
                      ...
                      children: [
                        ElevatedButton.icon(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: _hasPollSticker
                                ? Colors.red.shade100
                                : Colors.blue.shade100,
                            foregroundColor: _hasPollSticker
                                ? Colors.red.shade800
                                : Colors.blue.shade800,
                          ),
                          onPressed: () => setState(
                            () => _hasPollSticker = !_hasPollSticker,
                          ),
                          icon: Icon(
                            _hasPollSticker
                        ...
                        OutlinedButton.icon(
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                  'Location & Product tag picker opened!',
                                ),
                              ),
                            );
                          },
