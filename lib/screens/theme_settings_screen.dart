    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: const Text('Theme & Appearance', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              children: [
                ...
                Card(
                  ...
                  child: SwitchListTile(
                    secondary: Icon(Icons.dark_mode, color: themeNotifier.primaryColor),
                    title: Text(
                      'Dark Theme',
                      style: TextStyle(
                    ...
                    subtitle: Text(
                      ...
                      style: TextStyle(fontSize: 11, color: themeNotifier.isDarkMode ? Colors.white70 : Colors.grey),
                    ),
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final bool isSelected = themeNotifier.chatBackgroundColor == color;
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: isSelected ? themeNotifier.primaryColor : Colors.grey.shade300,
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 13,
                                color: color == const Color(0xFF121212) ? Colors.white : Colors.black87,
                              ),
                            ),
                            if (isSelected)
                              Icon(Icons.check_circle, color: themeNotifier.primaryColor, size: 20),
                          ],
                        ),
                      ),
                    );
