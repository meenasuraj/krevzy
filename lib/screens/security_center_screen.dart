    ...
    final shouldLogout = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            'Are you sure you want to logout from GAPSHAP?',
          ),
          actions: [
            TextButton(
              onPressed: () {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: const Text(
            'This will permanently delete your GAPSHAP '
    ...
    try {
      ...
      if (email == null || email.isEmpty) {
        throw FirebaseAuthException(
          code: 'missing-email',
          message:
              'No email address is available for re-authentication.',
        );
      }
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Scaffold(
        ...
        body: const Center(
          child: Text(
            'Please login to manage security.',
          ),
        ),
      );
    }
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Manage your GAPSHAP account security.',
                          textAlign:
                              TextAlign.center,
                          style:
                              Theme.of(context)
                ...
                Card(
                  child: ListTile(
                    ...
                    subtitle:
                        const Text(
                      'Permanently delete your GAPSHAP account.',
                    ),
                    trailing:
                        const Icon(
                      Icons
