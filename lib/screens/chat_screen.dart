...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _setChatLock() async {
    ...
    final result = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text('Set Chat Lock 🔒'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text('Create a PIN for this chat.'),
    ...
    if (result == true) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Chat Lock enabled 🔒')));
    }
  ...
  Future<void> _removeChatLock() async {
    ...
    if (result == true) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Chat Lock removed 🔓')));
    }
  }
      ...
      builder: (context) {
        return SafeArea(
          child: Column(
            ...
            children: [
              ListTile(
                leading: Icon(_isChatLocked ? Icons.lock_open : Icons.lock),
                title: Text(_isChatLocked ? 'Remove Chat Lock' : 'Chat Lock'),
                onTap: () {
