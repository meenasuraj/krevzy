...
class _LiveStreamScreenState extends State<LiveStreamScreen> {
  ...
  final List<Map<String, String>> _messages = [
    {
      'user': 'Rahul_V',
      'text': 'Great picture quality on that dome camera! 📷',
    },
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Special Creator Discount Available Now',
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Product link pinned to chat!'),
                        ),
                      );
                    },
                    child: const Text(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Received a Super Tip of ₹500! 🎉'),
                            ),
                          );
                        },
                      ),
