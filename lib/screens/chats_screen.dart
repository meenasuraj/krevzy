...
class _ChatsScreenState extends State<ChatsScreen> {
  ...
  Future<void> _openChat(String chatId, String otherUserId) async {
    try {
      ...
      final data =
          cachedData ?? (await UserService.getUserById(otherUserId)).data();
  ...
  Widget _buildAvatar({
    ...
    final isBlockedExternalPhoto =
        uri != null && uri.host.toLowerCase().contains('googleusercontent.com');
    final safePhotoUrl = isBlockedExternalPhoto ? '' : photoUrl;
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              _buildAvatar(photoUrl: photoUrl, locked: locked, unread: unread),
              const SizedBox(width: 14),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final sortedChats =
                      List<DocumentSnapshot<Map<String, dynamic>>>.from(chats);
                  ...
                  return RefreshIndicator(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return _buildChatTile(sortedChats[index]);
                      },
                    ),
                  );
                },
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 9),
            Text(
              'Find someone on krevzy and start your first conversation.',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
                height: 1.45,
