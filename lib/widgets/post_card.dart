...
class _PostCardState extends State<PostCard>
  ...
  Future<void> _loadSavedStatus() async {
    try {
      final saved = await PostActionsService.isSaved(widget.post.id);
  ...
  Future<void> _toggleSaved() async {
    ...
    try {
      final saved = await PostActionsService.toggleSaved(widget.post.id);
      if (mounted) {
